...
path_output_klein=/localdata/weathermaps/webside/gross
...
python /localdata/weathermaps/imuk/imageresizer.py $path_output_klein $path_output_4panel $path_output $xdim_1 $ydim_1 $xdim_2 $ydim_2
