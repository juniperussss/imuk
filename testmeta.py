def metarrequest(dirorigin):
    ...
    from cleaner import metarww, pressurereduction,cloudcover,nclwwstring
    ...
    with open(dirorigin+'/BUFR/full.json', 'r') as f:
    ...
    df=nclwwstring(df)
    metar_csv_data = df.to_csv(dirorigin+'/BUFR/metarsupp.csv', index = True)
    ...
    metar_groundlevel = datare.to_csv(dirorigin+'/BUFR/metar_groundlevel.csv', index = True)
