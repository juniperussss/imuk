...
def picture(vara,varb,number,resx,resy,dir_origin,filenames):
    ...
    gph500 = f2.variables['GP_P0_L100_GLL0'][:,:] /98.1
    ...
    left_string_2   = '500 hPa: Geopotential(gdm), Temperatur (Grad  ~F34~0~F~C)'  #model output info
    ...
    # ---- Crop Graphics
    imuktools.crop_image(number, '500_', wkres, resx, resy, filenames)
