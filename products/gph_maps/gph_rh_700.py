...
def picture(vara,varb,number,resx,resy,dir_origin,filenames):
    ...
    # ---- Crop Graphics
    imuktools.legend(number, '700_', 11, wkres.wkWidth, wkres.wkHeight, cmap_colors, list(var1res.cnLevels), filenames, 0, "%", dir_origin, resx)
    imuktools.crop_image(number, '700_', wkres, resx, resy, filenames)
