...
fn1          = dir + '/database/input/icon/2022/8/2/00/t/500/outfile_merged_2022080200_000_004_500_T.grib2' #path name of model output
...
temp500 = f1.variables['TMP_P0_L100_GLL0'][0,:,:] -273.15

dir         = os.path.join(dir_origin) #path of model output
fn2          = dir + '/database/input/icon/2022/8/2/00/fi/500/outfile_merged_2022080200_000_004_500_FI.grib2' #path name of model output
...
gph500 = f2.variables['GP_P0_L100_GLL0'][0,:,:] /98.1
...
temp500 = mpcalc.smooth_n_point(temp500, 9, 4)
gph500 = mpcalc.smooth_n_point(gph500, 9, 4)
...
wks             =  Ngl.open_wks(wks_type,'gph_temp_500', wkres)  #-- open workstation
...
var1res.cnMinLevelValF       = -50
var1res.cnMaxLevelValF       = 10
...
plot1    = Ngl.contour(wks, temp500, var1res) #gsn_csm_contour command
plot2    = Ngl.contour(wks, gph500, var2res) #gsn_csm_contour command
