...
fn1          = dir + 'database/input/icon/2022/8/1/00/t/500/outfile_merged_2022080100_000_004_500_T.grib2' #path name of model output
...
dir         = os.path.join('/media/juniperus/SONY/imuk/') #path of model output
fn2          = dir + 'database/input/icon/2022/8/1/00/fi/500/outfile_merged_2022080100_000_004_500_FI.grib2' #path name of model output
